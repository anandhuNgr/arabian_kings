...
function ServicesFour() {
  const service = serviceDetails.service4;
  ...
  return (
    <div>
      <PageHero
        ...
        text={service.text}
        image={service.image}
        primaryAction={{ label: 'Request Visa Assistance', to: '/contact' }}
      ...
      <section className="px-6 py-20 lg:px-8">
        <div className="mx-auto max-w-7xl">
          <SectionHeading
            ...
            title="Stress-free visa processing for your UAE travel plans"
            text="We support all major UAE visa types with document preparation, application submission and status tracking from start to finish."
          />

          <div className="mt-12 grid gap-8 lg:grid-cols-2">
            <div className="space-y-6 rounded-[2rem] border border-[#EAD8B1]/50 bg-white p-8 shadow-[0_20px_60px_rgba(7,26,43,0.08)]">
              <h3 className="text-xl font-semibold text-[#071A2B]">Service details</h3>
            ...
            <div className="space-y-6 rounded-[2rem] border border-[#EAD8B1]/50 bg-[#FAF7F0] p-8 shadow-[0_20px_60px_rgba(7,26,43,0.08)]">
              <h3 className="text-xl font-semibold text-[#071A2B]">Why customers trust us</h3>
              <ul className="space-y-4 text-sm text-[#20252A]/80">
